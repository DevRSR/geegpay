...
import OtherMenu from '../OtherMenu/Index'
...
function Index() {
  ...
  return (
    <div className=' dark:bg-slate-800 flex flex-col w-12 sm:w-20 h-auto gap-5'>
      <div className=' flex justify-center items-center w-full'>
        <div className='w-6 h-6 md:w-10 md:h-10 rounded-full dark:bg-white'>
          <svg className='w-6 h-6 md:w-10 md:h-10 ' xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
            <path className=' ' fill-rule="evenodd" clip-rule="evenodd" d="M20 40C31.0457 40 40 31.0457 40 20C40 8.95431 31.0457 0 20 0C8.95429 0 0 8.95431 0 20C0 31.0457 8.95429 40 20 40ZM26.2393 9.31684C26.543 8.23805 25.4961 7.60013 24.54 8.2813L11.1931 17.7896C10.1562 18.5283 10.3193 20 11.4381 20H14.9527V19.9728H21.8025L16.2212 21.9421L13.7607 30.6832C13.457 31.762 14.5038 32.3999 15.46 31.7187L28.8069 22.2105C29.8438 21.4718 29.6806 20 28.5619 20H23.2321L26.2393 9.31684Z" fill="#34CAA5"/>
          </svg>
        </div>
      </div>
      
      <div className=' flex flex-col w-full h-full gap-4'>
        <button onClick={() => handleClick('1') } id='1' className=' relative flex justify-center items-center w-full'>
          ...
          <motion.svg 
            animate={{ scaleY: activeId === '1' ? 1 : 1.5, opacity: activeId === '1' ? 1 : 0, display: activeId === '1' ? 'block' : 'none'}}
            transition={{ duration: 0.3, delay: 0.1 }}
            className={` ${ activeId === '1' ? 'block' : 'hidden'} h-[14px] md:h-[21px] absolute right-[1px] top-[1px]`} 
        ...
        <button onClick={() => handleClick('2')} id='2' className=' relative flex justify-center items-center w-full'>
          <svg className=' w-4 h-4 md:w-6 md:h-6 hover:scale-105' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <motion.svg 
            animate={{ scaleY: activeId === '2' ? 1 : 1.5, opacity: activeId === '2' ? 1 : 0, display: activeId === '2' ? 'block' : 'none'}}
            transition={{ duration: 0.3, delay: 0.1 }}
            className={` ${ activeId === '2' ? 'block' : 'hidden'} h-[14px] md:h-[21px]  absolute right-[1px] top-[1px]`} xmlns="http://www.w3.org/2000/svg" width="3" height="21" viewBox="0 0 3 21" fill="none">
            <path className=' dark:fill-white' d="M6.53467e-06 3.02509C7.11773e-06 1.42129 1.40951 0.182713 3 0.388889V21C1.34315 21 4.88293e-07 19.6569 1.09063e-06 18L6.53467e-06 3.02509Z" fill="#0D062D"/>
          </motion.svg>
        </button>
        <button onClick={ () => handleClick('3') } id='3'  className=' relative flex justify-center items-center w-full'>
          <svg className=' w-4 h-4 md:w-6 md:h-6 hover:scale-105' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <motion.svg 
            animate={{ scaleY: activeId === '3' ? 1 : 1.5, opacity: activeId === '3' ? 1 : 0, display: activeId === '3' ? 'block' : 'none'}}
            transition={{ duration: 0.3, delay: 0.1 }}
            className={` ${ activeId === '3' ? 'block' : 'hidden'} h-[14px] md:h-[21px]  absolute right-[1px] top-[1px]`} xmlns="http://www.w3.org/2000/svg" width="3" height="21" viewBox="0 0 3 21" fill="none">
            <path className=' dark:fill-white' d="M6.53467e-06 3.02509C7.11773e-06 1.42129 1.40951 0.182713 3 0.388889V21C1.34315 21 4.88293e-07 19.6569 1.09063e-06 18L6.53467e-06 3.02509Z" fill="#0D062D"/>
          </motion.svg>
        </button>
        <button onClick={ () => handleClick('4') } id='4'  className=' relative flex justify-center items-center w-full'>
          <svg className=' w-4 h-4 md:w-6 md:h-6 hover:scale-105' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <motion.svg
            animate={{ scaleY: activeId === '4' ? 1 : 1.5, opacity: activeId === '4' ? 1 : 0, display: activeId === '4' ? 'block' : 'none'}}
            transition={{ duration: 0.3, delay: 0.1 }} 
            className={` ${ activeId === '4' ? 'block' : 'hidden'} h-[14px] md:h-[21px]  absolute right-[1px] top-[1px]`} xmlns="http://www.w3.org/2000/svg" width="3" height="21" viewBox="0 0 3 21" fill="none">
            <path className=' dark:fill-white' d="M6.53467e-06 3.02509C7.11773e-06 1.42129 1.40951 0.182713 3 0.388889V21C1.34315 21 4.88293e-07 19.6569 1.09063e-06 18L6.53467e-06 3.02509Z" fill="#0D062D"/>
          </motion.svg>
        </button>
        <button onClick={ () => handleClick('5') } id='5'  className=' relative flex justify-center items-center w-full'>
          <svg className=' w-4 h-4 md:w-6 md:h-6 hover:scale-105' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <motion.svg 
            animate={{ scaleY: activeId === '5' ? 1 : 1.5, opacity: activeId === '5' ? 1 : 0, display: activeId === '5' ? 'block' : 'none'}}
            transition={{ duration: 0.3, delay: 0.1 }}
            className={` ${ activeId === '5' ? 'block' : 'hidden'} h-[14px] md:h-[21px]  absolute right-[1px] top-[1px]`} xmlns="http://www.w3.org/2000/svg" width="3" height="21" viewBox="0 0 3 21" fill="none">
            <path className=' dark:fill-white' d="M6.53467e-06 3.02509C7.11773e-06 1.42129 1.40951 0.182713 3 0.388889V21C1.34315 21 4.88293e-07 19.6569 1.09063e-06 18L6.53467e-06 3.02509Z" fill="#0D062D"/>
          </motion.svg>
        </button>
        <button onClick={ () => handleClick('6') } id='6' className=' relative flex justify-center items-center w-full'>
          <svg className=' w-4 h-4 md:w-6 md:h-6 hover:scale-105' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <motion.svg 
            animate={{ scaleY: activeId === '6' ? 1 : 1.5, opacity: activeId === '6' ? 1 : 0, display: activeId === '6' ? 'block' : 'none'}}
            transition={{ duration: 0.3, delay: 0.1 }}
            className={` ${ activeId === '6' ? 'block' : 'hidden'} h-[14px] md:h-[21px]  absolute right-[1px] top-[1px]`} xmlns="http://www.w3.org/2000/svg" width="3" height="21" viewBox="0 0 3 21" fill="none">
            <path className=' dark:fill-white' d="M6.53467e-06 3.02509C7.11773e-06 1.42129 1.40951 0.182713 3 0.388889V21C1.34315 21 4.88293e-07 19.6569 1.09063e-06 18L6.53467e-06 3.02509Z" fill="#0D062D"/>
          </motion.svg>
        </button>

        <div className=' flex justify-center items-center w-full '>
          <div className="flex flex-col items-center gap-4 w-auto h-auto p-1 md:p-2 dark:bg-slate-700 bg-white rounded-full">
            <button onClick={removeDarkMode} className={` flex justify-center items-center w-full h-full ${ !active ? 'rounded-full p-1 md:p-2 bg-[#34CAA5]' : ''}`}>
              <svg className={` ${ !active ? 'w-3 h-3 md:w-[18px] md:h-[18px]' : 'w-5 h-5 md:w-[30px] md:h-[30px]' } `} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
            ...
            <button onClick={addDarkMode} className={` flex justify-center items-center w-full ${ active ? 'rounded-full p-1 md:p-2 bg-[#34CAA5]' : ''} `}>
              <svg className={`${ active ? 'w-3 h-3 md:w-[18px] md:h-[18px]' : 'w-5 h-5 md:w-[30px] md:h-[30px]' }`} xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
        ...
        <div className=' flex justify-center items-center w-full mt-48'>
          <OtherMenu activeId={activeId} handleClick={handleClick} />
        </div>
      </div>
    </div>
  )
