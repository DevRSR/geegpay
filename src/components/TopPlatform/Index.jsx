...
function Index() {
  return (
    <div className=' xl:ml-[6px] p-3 bg-[#fff] dark:bg-slate-700 sm:p-5 lg:p-3 xl:p-4 rounded-lg shadow flex-1 lg:max-w-[488px] xl:max-h-[542px]'>
        <div>
            <Header />
        </div>
        { data.map(item =>(
        <div className=' flex flex-col mb-5 items-center w-full font-serif'>
